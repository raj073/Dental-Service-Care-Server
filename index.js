...
async function run() {
    try {
        const serviceCollection = client.db('newDB').collection('services');
        const reviewCollection = client.db('newDB').collection('reviews');
...
app.listen(port, () => {
    console.log('Dental Care Service Server Running on Port', port);
})
